...
function updateUI() {
    ...
    document.getElementById('dirt-click-level').textContent = dirtMat.clickLevel;
    ...
    document.getElementById('dirt-click-bonus').textContent = dirtMat.clickLevel + 1;
    document.getElementById('dirt-auto-bonus').textContent = ((dirtMat.autoLevel + 1) * 0.5).toFixed(1);
    ...
    document.getElementById('grass-click-level').textContent = grassMat.clickLevel;
    document.getElementById('grass-auto-level').textContent = grassMat.autoLevel;
    // Показываем следующий бонус
    document.getElementById('grass-click-bonus').textContent = (grassMat.clickLevel + 1) * 5;
    document.getElementById('grass-auto-bonus').textContent = (grassMat.autoLevel + 1) * 2;
    ...
    document.getElementById('wood-click-level').textContent = woodMat.clickLevel;
    document.getElementById('wood-auto-level').textContent = woodMat.autoLevel;
    // Показываем следующий бонус
    document.getElementById('wood-click-bonus').textContent = (woodMat.clickLevel + 1) * 25;
    document.getElementById('wood-auto-bonus').textContent = (woodMat.autoLevel + 1) * 10;
    ...
    document.getElementById('stone-click-level').textContent = stoneMat.clickLevel;
    document.getElementById('stone-auto-level').textContent = stoneMat.autoLevel;
    // Показываем следующий бонус
    document.getElementById('stone-click-bonus').textContent = (stoneMat.clickLevel + 1) * 125;
    document.getElementById('stone-auto-bonus').textContent = (stoneMat.autoLevel + 1) * 50;
    ...
    document.getElementById('metal-click-level').textContent = metalMat.clickLevel;
    document.getElementById('metal-auto-level').textContent = metalMat.autoLevel;
    // Показываем следующий бонус
    document.getElementById('metal-click-bonus').textContent = (metalMat.clickLevel + 1) * 625;
    document.getElementById('metal-auto-bonus').textContent = (metalMat.autoLevel + 1) * 250;
